...
export default function SignupPage() {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-[100dvh] overflow-hidden bg-neutral-950 z-10">
            ...
            >
                ...
                <motion.div
                    ...
                    className="bg-neutral-900/50 backdrop-blur-3xl border border-white/10 p-6 rounded-3xl shadow-2xl overflow-hidden"
                >
                    {errorMsg && (
                        ...
                        {step === 1 && (
                            ...
                            >
                                <input
                                    ...
                                    required
                                    className="w-full h-14 bg-neutral-950/50 border border-neutral-800 rounded-2xl px-5 text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all font-medium"
                                />
                                <input
                                    type="text"
                                ...
                                <input
                                    ...
                                    required
                                    minLength={6}
                                    className="w-full h-14 bg-neutral-950/50 border border-neutral-800 rounded-2xl px-5 text-white placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all font-medium"
                                />
                        ...
                        {step === 2 && (
                            ...
                            >
                                <div className="text-center mb-6">
                                    <p className="text-sm text-neutral-400 font-medium">Бид <span className="text-white font-bold">{emailOrPhone}</span> хаяг руу 6 оронтой код илгээсэн. Та кодоо оруулж баталгаажуулна уу.</p>
                                ...
                                <input
                                    ...
                                    required
                                    maxLength={6}
                                    className="w-full h-16 text-center text-3xl tracking-[0.5em] bg-neutral-950/50 border border-neutral-800 rounded-2xl px-5 text-white focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all font-black"
                                />
                                ...
                                <motion.button
                                    ...
                                    type="submit"
                                    disabled={loading}
                                    className="w-full h-14 mt-4 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center gap-2 text-white font-bold text-lg shadow-[0_10px_40px_-10px_rgba(16,185,129,0.5)] transition-all disabled:opacity-70 disabled:scale-100"
                                >
