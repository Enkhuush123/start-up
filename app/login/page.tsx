        ...
        <div className="relative flex flex-col items-center justify-center min-h-[100dvh] overflow-hidden bg-neutral-950 z-10">
            ...
            >
                ...
                <motion.div
                    ...
                    className="bg-neutral-900/50 backdrop-blur-3xl border border-white/10 p-6 rounded-3xl shadow-2xl"
                >
                    ...
                    <div className="mt-6 text-center">
                        <Link href="/signup" className="text-sm font-bold text-neutral-400 hover:text-white transition-colors">
