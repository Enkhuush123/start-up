        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h3 className="text-2xl font-bold mb-3 relative z-10">
              🙈 Сохор болзоо (Blind Date)
            </h3>
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed max-w-md">
              Гадаад төрх бус, дотоод ертөнцийг нь түрүүлж тань. Зураг бүдэгхэн
              эхэлж, та хоёр чатлах тусам бага багаар тодорсоор 100% харагдах
              болно.
            </p>
          </motion.div>
          ...
          <motion.div
            whileHover={{ scale: 1.02 }}
            className="col-span-1 md:col-span-2 lg:col-span-1 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 p-8 rounded-3xl relative overflow-hidden group flex flex-col"
          >
            <div className="absolute top-0 right-0 p-8 opacity-20 group-hover:opacity-40 transition-opacity">
            ...
            <h3 className="text-2xl font-bold mb-3 relative z-10 text-emerald-600 dark:text-emerald-400">
              📍 Fizz Map{" "}
              <span className="text-xs bg-emerald-500 text-white px-2 py-1 rounded-full ml-2 align-middle">
                Онцгой
              </span>
            </h3>
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed flex-1">
              Найзуудыгаа яг одоо хаана явж байгааг газрын зураг (Map) дээрээс
              харах боломжтой.
            </p>
            <Link
              href="/map"
              className="relative z-10 mt-6 inline-flex items-center justify-center gap-2 px-5 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold transition-all w-fit shadow-[0_5px_15px_rgba(16,185,129,0.4)]"
            >
              Газрын зураг руу орох <ArrowRight size={18} />
            </Link>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed">
              Хилэнц, Мэлхий хоёр хэр сайн тохирох бол? AI та хоёрын ордны
              зохицлыг %-иар шууд тооцоолж харуулна.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed">
              Чат эхлүүлэх үг олдохгүй байна уу? Манай AI Wingman танд хамгийн
              сонирхолтой сэдвүүдийг санал болгох болно.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed">
              Энэ зургаараа хэр олон хүнтэй таарах бол? AI таны зургийг шүүгээд,
              илүү сайжруулах гоё зөвлөгөөнүүдийг өгнө.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed max-w-md">
              Таны харилцаж байгаа хүн яг одоо ямар сэтгэл хөдлөлтэй байгааг AI
              чатнаас нь шинжилж, танд зөвхөн Emoji-гоор дүрсэлж харуулна.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-600 dark:text-neutral-300 relative z-10 font-medium leading-relaxed">
              Та хоёрын хобби болон одоогийн байршилд яг тохирох төгс болзооны
              санааг манай AI автоматаар санал болгоно.
            </p>
          </motion.div>
        </div>
      </div>
